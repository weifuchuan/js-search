...
var Search = /*#__PURE__*/function () {
  ...
  _proto.searchAsync = /*#__PURE__*/function () {
    var _searchAsync = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(query, tokenize) {
      var tokens;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return tokenize(this._sanitizer.sanitize(query));

            case 2:
              tokens = _context.sent;
              return _context.abrupt("return", this._searchIndex.search(tokens, this._documents));
